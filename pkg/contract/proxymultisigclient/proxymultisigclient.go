...
// GetClientStateSignBytes is a free data retrieval call binding the contract method 0xe0e1ecd5.
//
// Solidity: function getClientStateSignBytes(uint64 height, uint64 timestamp, string diversifier, string clientID, bytes clientState) pure returns(bytes)
func (_Proxymultisigclient *ProxymultisigclientCaller) GetClientStateSignBytes(opts *bind.CallOpts, height uint64, timestamp uint64, diversifier string, clientID string, clientState []byte) ([]byte, error) {
	var out []interface{}
	err := _Proxymultisigclient.contract.Call(opts, &out, "getClientStateSignBytes", height, timestamp, diversifier, clientID, clientState)
...
//
// Solidity: function getClientStateSignBytes(uint64 height, uint64 timestamp, string diversifier, string clientID, bytes clientState) pure returns(bytes)
func (_Proxymultisigclient *ProxymultisigclientSession) GetClientStateSignBytes(height uint64, timestamp uint64, diversifier string, clientID string, clientState []byte) ([]byte, error) {
	return _Proxymultisigclient.Contract.GetClientStateSignBytes(&_Proxymultisigclient.CallOpts, height, timestamp, diversifier, clientID, clientState)
}

// GetClientStateSignBytes is a free data retrieval call binding the contract method 0xe0e1ecd5.
//
// Solidity: function getClientStateSignBytes(uint64 height, uint64 timestamp, string diversifier, string clientID, bytes clientState) pure returns(bytes)
func (_Proxymultisigclient *ProxymultisigclientCallerSession) GetClientStateSignBytes(height uint64, timestamp uint64, diversifier string, clientID string, clientState []byte) ([]byte, error) {
	return _Proxymultisigclient.Contract.GetClientStateSignBytes(&_Proxymultisigclient.CallOpts, height, timestamp, diversifier, clientID, clientState)
}
...
// MakeProxyCommitmentPrefix is a free data retrieval call binding the contract method 0xed375de4.
//
// Solidity: function makeProxyCommitmentPrefix(bytes proxyKeyPrefix, bytes counterpartyPrefix) pure returns(bytes)
func (_Proxymultisigclient *ProxymultisigclientCaller) MakeProxyCommitmentPrefix(opts *bind.CallOpts, proxyKeyPrefix []byte, counterpartyPrefix []byte) ([]byte, error) {
	var out []interface{}
	err := _Proxymultisigclient.contract.Call(opts, &out, "makeProxyCommitmentPrefix", proxyKeyPrefix, counterpartyPrefix)
...
//
// Solidity: function makeProxyCommitmentPrefix(bytes proxyKeyPrefix, bytes counterpartyPrefix) pure returns(bytes)
func (_Proxymultisigclient *ProxymultisigclientSession) MakeProxyCommitmentPrefix(proxyKeyPrefix []byte, counterpartyPrefix []byte) ([]byte, error) {
	return _Proxymultisigclient.Contract.MakeProxyCommitmentPrefix(&_Proxymultisigclient.CallOpts, proxyKeyPrefix, counterpartyPrefix)
}

// MakeProxyCommitmentPrefix is a free data retrieval call binding the contract method 0xed375de4.
//
// Solidity: function makeProxyCommitmentPrefix(bytes proxyKeyPrefix, bytes counterpartyPrefix) pure returns(bytes)
func (_Proxymultisigclient *ProxymultisigclientCallerSession) MakeProxyCommitmentPrefix(proxyKeyPrefix []byte, counterpartyPrefix []byte) ([]byte, error) {
	return _Proxymultisigclient.Contract.MakeProxyCommitmentPrefix(&_Proxymultisigclient.CallOpts, proxyKeyPrefix, counterpartyPrefix)
}
...
// VerifySignature is a free data retrieval call binding the contract method 0x95be76d3.
//
// Solidity: function verifySignature((bytes[],string,uint64) consensusState, (bytes[]) multisig, bytes signBytes) pure returns(bool)
