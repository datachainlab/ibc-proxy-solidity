...
// MakeClientStateSignBytes is a free data retrieval call binding the contract method 0x9ae21ddd.
//
// Solidity: function makeClientStateSignBytes(uint64 height, uint64 timestamp, string diversifier, string clientID, bytes clientState) pure returns(bytes)
func (_Proxymultisigclient *ProxymultisigclientCaller) MakeClientStateSignBytes(opts *bind.CallOpts, height uint64, timestamp uint64, diversifier string, clientID string, clientState []byte) ([]byte, error) {
	var out []interface{}
	err := _Proxymultisigclient.contract.Call(opts, &out, "makeClientStateSignBytes", height, timestamp, diversifier, clientID, clientState)
...
//
// Solidity: function makeClientStateSignBytes(uint64 height, uint64 timestamp, string diversifier, string clientID, bytes clientState) pure returns(bytes)
func (_Proxymultisigclient *ProxymultisigclientSession) MakeClientStateSignBytes(height uint64, timestamp uint64, diversifier string, clientID string, clientState []byte) ([]byte, error) {
	return _Proxymultisigclient.Contract.MakeClientStateSignBytes(&_Proxymultisigclient.CallOpts, height, timestamp, diversifier, clientID, clientState)
}

// MakeClientStateSignBytes is a free data retrieval call binding the contract method 0x9ae21ddd.
//
// Solidity: function makeClientStateSignBytes(uint64 height, uint64 timestamp, string diversifier, string clientID, bytes clientState) pure returns(bytes)
func (_Proxymultisigclient *ProxymultisigclientCallerSession) MakeClientStateSignBytes(height uint64, timestamp uint64, diversifier string, clientID string, clientState []byte) ([]byte, error) {
	return _Proxymultisigclient.Contract.MakeClientStateSignBytes(&_Proxymultisigclient.CallOpts, height, timestamp, diversifier, clientID, clientState)
}
