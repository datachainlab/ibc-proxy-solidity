...
func (_Multisigclient *MultisigclientCaller) GetClientStateSignBytes(opts *bind.CallOpts, height uint64, timestamp uint64, diversifier string, clientID string, clientState []byte) ([]byte, error) {
	var out []interface{}
	err := _Multisigclient.contract.Call(opts, &out, "getClientStateSignBytes", height, timestamp, diversifier, clientID, clientState)
...
//
// Solidity: function getClientStateSignBytes(uint64 height, uint64 timestamp, string diversifier, string clientID, bytes clientState) pure returns(bytes)
func (_Multisigclient *MultisigclientSession) GetClientStateSignBytes(height uint64, timestamp uint64, diversifier string, clientID string, clientState []byte) ([]byte, error) {
	return _Multisigclient.Contract.GetClientStateSignBytes(&_Multisigclient.CallOpts, height, timestamp, diversifier, clientID, clientState)
}

// GetClientStateSignBytes is a free data retrieval call binding the contract method 0xe0e1ecd5.
//
// Solidity: function getClientStateSignBytes(uint64 height, uint64 timestamp, string diversifier, string clientID, bytes clientState) pure returns(bytes)
func (_Multisigclient *MultisigclientCallerSession) GetClientStateSignBytes(height uint64, timestamp uint64, diversifier string, clientID string, clientState []byte) ([]byte, error) {
	return _Multisigclient.Contract.GetClientStateSignBytes(&_Multisigclient.CallOpts, height, timestamp, diversifier, clientID, clientState)
}
