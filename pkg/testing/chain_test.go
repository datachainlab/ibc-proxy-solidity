...
import (
	...
	"github.com/datachainlab/ibc-proxy-solidity/pkg/contract/ibchost"
	"github.com/datachainlab/ibc-proxy-solidity/pkg/contract/multisigclient"
	"github.com/datachainlab/ibc-proxy-solidity/pkg/contract/proxymultisigclient"
	"github.com/datachainlab/ibc-proxy-solidity/pkg/wallet"
)
...
type Chain struct {
	...
	proxymultisigClient proxymultisigclient.Proxymultisigclient
}
...
func NewChain(t *testing.T, rpcAddr string, mnemonicPhrase string, ccfg ContractConfig) *Chain {
	...
	psc, err := proxymultisigclient.NewProxymultisigclient(ccfg.GetProxyMultisigClientAddress(), ethc)
	if err != nil {
		panic(err)
	}
	return &Chain{
...
type ContractConfig interface {
	...
	GetProxyMultisigClientAddress() common.Address
}
